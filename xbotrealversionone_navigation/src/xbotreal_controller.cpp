...
double wheelbase = 0.42;                          //Wheelbase, in m
...
int main(int argc, char** argv){
  ros::init(argc, argv, "xbotreal_controller");
  ...
  bool publish_tf = true; // default = true
  double dt = 0.0;
  double dx = 0.0;
  double dy = 0.0;
  double dth = 0.0;
  ...
  while(n.ok()){
    ...
    if (speed_act_left == 0 && speed_act_right == 0){
      ...
      odom_msg.pose.covariance[8] = 1e-6;
      odom_msg.pose.covariance[14] = 1e3;
      ...
      odom_msg.twist.covariance[8] = 1e-6;
      ...
      odom_msg.pose.covariance[8] = 0.1;
      odom_msg.pose.covariance[14] = 1e3;
      odom_msg.pose.covariance[21] = 1e3;
      odom_msg.pose.covariance[28] = 1e3;
