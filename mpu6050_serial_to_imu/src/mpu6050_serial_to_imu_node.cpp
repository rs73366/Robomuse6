...
int main(int argc, char** argv)
{
  ...
  bool broadcast_tf;
  double linear_acceleration_stddev = 0.01;
  double angular_velocity_stddev = 0.008;
  double orientation_stddev = 0.0001;
  ...
  private_node_handle.param<double>("linear_acceleration_stddev", linear_acceleration_stddev, 0.09);
  private_node_handle.param<double>("angular_velocity_stddev", angular_velocity_stddev, 0.008);
  private_node_handle.param<double>("orientation_stddev", orientation_stddev, 0.0001);
  ...
  ros::Rate r(200); // 200 hz changed by rahul
